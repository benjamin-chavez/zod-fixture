...
// const castAs = <T extends ZodType>(typeName: string) => {
...
// export const ZodArray = castAs<TrueZodArray<ZodType>>('ZodArray');
// export const ZodObject = castAs<TrueZodObject<ZodRawShape>>('ZodObject');
// export const ZodUnion =
// 	castAs<TrueZodUnion<readonly [ZodType, ...ZodType[]]>>('ZodUnion');
...
// 	castAs<TrueZodIntersection<ZodType, ZodType>>('ZodIntersection');
...
// 	castAs<TrueZodFunction<TrueZodTuple<[], ZodType>, ZodType>>('ZodFunction');
// export const ZodLazy = castAs<TrueZodLazy<ZodType>>('ZodLazy');
...
// export const ZodEffects = castAs<TrueZodEffects<ZodType>>('ZodEffects');
// export const ZodNativeEnum =
// 	castAs<TrueZodNativeEnum<EnumLike>>('ZodNativeEnum');
// export const ZodOptional = castAs<TrueZodOptional<ZodType>>('ZodOptional');
// export const ZodNullable = castAs<TrueZodNullable<ZodType>>('ZodNullable');
// export const ZodDefault = castAs<TrueZodDefault<ZodType>>('ZodDefault');
// export const ZodCatch = castAs<TrueZodCatch<ZodType>>('ZodCatch');
// export const ZodPromise = castAs<TrueZodPromise<ZodType>>('ZodPromise');
// export const ZodBranded =
// 	castAs<TrueZodBranded<ZodType, PropertyKey>>('ZodBranded');
// export const ZodPipeline =
// 	castAs<TrueZodPipeline<ZodType, ZodType>>('ZodPipeline');
// export const ZodReadonly = castAs<TrueZodReadonly<ZodType>>('ZodReadonly');
//
...
// export type { ZodStringDef, ZodType };
// /* eslint-enable @typescript-eslint/no-explicit-any */

// src/internal/zod.ts

// Re-export Zod v4 types directly
export {
	ZodAny,
	ZodArray,
	ZodBigInt,
...
// Infer output type from a Zod schema
export type InferZodType<T> = T extends { _output: unknown }
	? T['_output']
	: unknown;

// Used by intersection generator for merging values
export enum ZodParsedType {
	function = 'function',
	number = 'number',
	string = 'string',
